...
export function resetPassword(infoEmail) {
...
export function createNewPassword(infoPassword) {
  return function (dispatch) {
    dispatch({
...
export function registrationUser(infoUser) {
  return function (dispatch) {
    dispatch({
...
export function authenticationUser(infoUser) {
  return function (dispatch) {
    dispatch({
